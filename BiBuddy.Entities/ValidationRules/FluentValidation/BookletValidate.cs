...
{
    public class BookletValidate : AbstractValidator<booklet>
    {
        public BookletValidate()
        {
            #region Author
            ...
            #region Howpublished
            //RuleFor(a => a.howpublished).NotEmpty().WithMessage(errorMessage: ErrorMessages.HowPublishedIsRequired);
            RuleFor(a => a.howpublished).MinimumLength(2).WithMessage(errorMessage: ErrorMessages.HowPublishedMinLength);
            RuleFor(a => a.howpublished).MaximumLength(250).WithMessage(errorMessage: ErrorMessages.HowPublishedMaxLength);
            #endregion
